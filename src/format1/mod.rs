...
pub use package::{restore_package_v2, RestoredPackageV2};
pub use persistence::{
...
pub use v2::{
    admit_v2, create_v2, migrate_aggregate_v2, migrate_aggregate_v2_route, restore_aggregate_v2,
    step_v2, AdmissionDelivery, QueueBearingAggregate, QueueEnvelope, Version2Error,
};
pub use wire::{PersistenceError, PersistenceErrorCode, TypedValue};
