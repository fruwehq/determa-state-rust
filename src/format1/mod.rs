...
pub use v2::{
    admit_v2, create_v2, downgrade_aggregate_v2_to_v1, migrate_aggregate_v2,
    migrate_aggregate_v2_route, restore_aggregate_v2, step_v2, upgrade_aggregate_v1_to_v2,
    AdmissionDelivery, QueueBearingAggregate, QueueEnvelope, Version2Error,
};
pub use wire::{
